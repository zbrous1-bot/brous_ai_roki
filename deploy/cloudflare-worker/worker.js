  ...
  async fetch(request, env) {
    ...
    if (pathname === '/' || pathname === '/api' || pathname === '/api/health') {
      return jsonResponse({
        ...
        // TEMP DIAGNOSTIC — remove after secret-visibility test. Reports which env
        // keys the running Worker actually sees, WITHOUT exposing any values.
        diag_env_keys: Object.keys(env || {}),
        diag_has_test_secret: !!env.TEST_DIAG_SECRET,
      }, 200, request);
    }
